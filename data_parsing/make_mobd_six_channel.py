...
sites = ["MS21"] # ["MS10", "MS21", "MS24", "MS25"] # ["MS21", "MS10", "MS24", "MS25"]
    ...
    for datafile in file_list:
        ...
        if total_duration_seconds <= seconds_in_a_sample:
            ...
            try:
                ...
                print(f"[WARNING] NumPy overflowed on PID {pid}. Defaulting start_time to min_time.")
                start_time = min_time
        ...
        for i in range(0, len(sampled_data), window_step_len):
            ...
            x = w[["acc_x", "acc_y", "acc_z", "gyr_x", "gyr_y", "gyr_z"]].values
            t = w["timestamp"].max()
