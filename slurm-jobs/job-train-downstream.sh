...
python /users/acp25lmc/ssl-wearables/downstream_task_evaluation.py "data=mobd_10s" "evaluation=all" "evaluation.flip_net_path=/users/acp25lmc/ssl-wearables/model_check_point/mtl_best.mdl"
